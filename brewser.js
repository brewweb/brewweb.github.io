...
function resultItem(bar){
	...
	(addressPictogram = createDiv("pictogram")).innerHTML = "<img src=\"pictograms/address.png\" width=\"13px\" height=\"13px\">";
	(webPictogram = createDiv("pictogram")).innerHTML = "<img src=\"pictograms/web.png\" width=\"13px\" height=\"13px\">";
	(phonePictogram = createDiv("pictogram")).innerHTML = "<img src=\"pictograms/phone.png\" width=\"13px\" height=\"13px\">";
	(clockPictogram = createDiv("pictogram")).innerHTML = "<img src=\"pictograms/clock.png\" width=\"13px\" height=\"13px\">";
...
function popUp(snapshot){
	...
	var popupAddress = "<div class='popupPictogram'><img src=\"pictograms/address.png\" width=\"15px\" height=\"15px\"></div><div class = 'popupInfoSlot'>" + snapshot.child("address").val() + "</div>";

	var popupWeb = "<div class='popupPictogram'><img src=\"pictograms/web.png\" width=\"15px\" height=\"15px\"></div><div class = 'popupInfoSlot'>" + snapshot.child("web").val() + "</div>";

	var popupPhone = "<div class='popupPictogram'><img src=\"pictograms/phone.png\" width=\"15px\" height=\"15px\"></div><div class = 'popupInfoSlot'>" + snapshot.child("phone").val() + "</div>";
...
/*
	...
	spusta sa pri kazdom stlaceni klavesy
*/
var timeout = null;
